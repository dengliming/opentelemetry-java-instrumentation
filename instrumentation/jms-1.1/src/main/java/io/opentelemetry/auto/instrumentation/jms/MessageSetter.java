...
public class MessageSetter implements HttpTextFormat.Setter<Message> {

  private static final Logger log = LoggerFactory.getLogger(MessageSetter.class);

  public static final MessageSetter SETTER = new MessageSetter();
