...
public class AkkaHttpRequestGetter implements HttpTextFormat.Getter<HttpRequest> {

  public static final AkkaHttpRequestGetter GETTER = new AkkaHttpRequestGetter();
