...
public class KHttpHeadersSetter implements HttpTextFormat.Setter<Map<String, String>> {
  ...
  public static final KHttpHeadersSetter SETTER = new KHttpHeadersSetter();
