...
public final class MultivaluedMapSetter implements HttpTextFormat.Setter<MultivaluedMap> {

  public static final MultivaluedMapSetter SETTER = new MultivaluedMapSetter();
